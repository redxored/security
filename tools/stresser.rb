...
def choice 
	...
	puts "10 is for HTTP Get and POST flooding"
	puts "11 is for HTTPS Get and POST flooding"
	...
	if thechoice == 1
		...
		tc1 = Thread.new{getflood}
		tc2 = Thread.new{postflood}
		tc1.join
		tc2.join
	elsif thechoice == 11
		tc3 = Thread.new{httpspost}
		tc4 = Thread.new{httpsget}
		tc3.join 
		tc4.join
	else 
		puts "Unknown Option"
